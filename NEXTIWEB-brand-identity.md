...
|-------|--------|
| **Nom** | NEXTIWEB |
| **Type** | Agence web indépendante |
| **Fondatrice** | Khadija AitLassri |
| **Ville** | Montréal, Québec, Canada |
| **Fondée** | 2023 (post-COVID, après vente d'une franchise) |
| **NEQ** | 2272348204 |
| **Tagline principal** | *Un site qui génère des vrais clients* |
| **Promesse** | Création de sites web, SEO et marketing digital pensés pour convertir les visiteurs en clients |
| **Cible** | PME québécoises et canadiennes (toute industrie, priorité Montréal) |
...
#### Mode sombre (identité principale du site)
| Rôle | Hex | Usage |
|------|-----|-------|
| **Vert primaire** | `#00e676` | Accent, CTA, icônes, titres en valeur |
| **Vert foncé** | `#009e4f` | Hover, variante secondaire |
| **Vert profond** | `#006837` | Liens mode clair, profondeur |
| **Fond principal** | `#0f0f0f` | Arrière-plan général |
| **Fond alt** | `#000000` | Sections alternées, footer |
| **Surface** | `#111111` | Cartes, panneaux |
| **Texte blanc** | `#ffffff` | Titres, texte principal |
| **Texte atténué** | `#c8c8c8` | Corps de texte, sous-titres |
| **Texte léger** | `#9a9a9a` | Labels, meta |
| **Bordure** | `#1a1a1a` | Séparateurs discrets |

#### Mode clair (variante)
| Rôle | Hex |
|------|-----|
| Fond principal | `#f5efe6` (crème chaud) |
| Fond alt | `#fffdf9` |
| Texte | `#171717` |
| Accent (inchangé) | `#00e676` |

#### Couleurs d'accentuation supplémentaires (visuels)
| Rôle | Hex | Usage |
|------|-----|-------|
| Orange FOMO | `#fb923c` | Urgence, alertes |
| Rouge danger | `#ef4444` | Points négatifs |
| Vert WhatsApp | `#25d366` | Bouton WhatsApp uniquement |

### Typographie

| Rôle | Police | Notes |
|------|--------|-------|
| **Corps / UI** | system-ui, -apple-system, "Segoe UI", Roboto, Arial | Pas de Google Font pour le corps |
...
| **Langue principale** | Français canadien |
| **Langue secondaire** | Anglais canadien |
| **Email** | contact@nextiweb.ca |
| **Téléphone** | 514-791-0591 |
| **WhatsApp** | https://wa.me/15147910591 |
| **GitHub** | https://github.com/lassrikhadija/zaki-khadija |

---

## 5. ADN DE LA MARQUE

### Histoire de la fondatrice (à utiliser dans les posts LinkedIn)
...
## 6. PROMPT TYPE POUR GÉNÉRATION D'IMAGES

### Pour Canva / Adobe Express / Midjourney / DALL-E
...
### Prompt Midjourney / DALL-E (image éditoriale LinkedIn)
```
Professional digital agency founder portrait concept, dark background #0f0f0f,
electric green #00e676 accent lighting, clean modern tech aesthetic,
Montréal Canada, confident entrepreneur woman, minimal design,
no gradients, high contrast, editorial style --ar 1:1 --style raw
```

---

## 7. VOIX ÉDITORIALE (LinkedIn)

| | Oui | Non |
|--|-----|-----|
| **Ton** | Direct, concret, première personne | Corporatif, distant, jargon |
| **Longueur** | Courts hooks + développement structuré | Pavés sans aération |
| **Preuve** | Chiffres sourcés, expérience personnelle | Stats inventées |
| **CTA** | "Posez-moi une question", "Audit gratuit" | "Cliquez ici", "Offre limitée" |
| **Emoji** | Rares, fonctionnels (→ ✓ ✗) | Décoratifs en quantité |

### Exemples de hooks LinkedIn efficaces pour NEXTIWEB
- *"J'ai créé mon premier site web. Il était parfait techniquement. Personne ne l'a trouvé."*
